...
class Daguerreo():
    ...
    def joint_optimization(self, x, loss, args):
        ...
        # self.estimator = self.estimator_cls(self.d, 1, 1) # init

        # optim = get_optimizer(self.smap_masking.parameters() + , name=args.optimizer, lr=args.lr_theta)  # to update sparsemap parameters
        ...
        #     alphas, orderings = self.smap_masking(args.smap_tmp, args.smap_init, args.smap_iter)
        #     num_orderings = len(alphas)
